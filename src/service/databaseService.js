...
export class DatabaseService {
  ...
  async creatPost({ title, slug, content, image, status, category, price }) {
    try {
  ...
  async updatePost(
    id,
    { title, slug, content, image, status, category, price }
  ) {
    try {
