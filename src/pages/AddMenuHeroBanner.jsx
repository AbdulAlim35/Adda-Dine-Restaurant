...
const onSubmit = async (data) => {
    ...
    try {
      if (menu) {
        upload = await menuHeroBanner.updatePost(menu.$id, prepardData);
      } else {
        upload = await menuHeroBanner.creatPost(prepardData);
      }
    ...
    const featchData = async () => {
      const section = await menuHeroBanner.listQuery();
...
export default AddMenuHeroBanner