...
function AddGalleryHeroBanner() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      if (gallery) {
        upload = await galleryHeroBannerDatabase.updatePost(gallery.$id, prepardData);
      } else {
        upload = await galleryHeroBannerDatabase.creatPost(prepardData);
      }
  ...
  useEffect(() => {
    const featchData = async () => {
      const section = await galleryHeroBannerDatabase.listQuery();
...
export default AddGalleryHeroBanner