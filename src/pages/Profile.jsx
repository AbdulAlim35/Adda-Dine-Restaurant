...
function Profile() {
  ...
  const handleImage = async (e) => {
    ...
    setLoding(true);
    try {
      const image = await storageService.uplodFile(selectFile);
      const profileData = await profileDatabas.listQuery(authInfo.$id);
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <div className="flex justify-end pt-6 border-t border-gray-200">
                    <button
                      type="submit"
                      className="inline-flex items-center px-6 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition-colors duration-200 cursor-pointer"
                    >
                      Save Changes
                    </button>
                  </div>
