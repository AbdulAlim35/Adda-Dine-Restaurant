...
function AddBlog() {
  ...
  const submit = async (data) => {
    ...
    try {
      if (id) {
        upload = await databaseService.updatePost(id, prepardData);
      } else {
        upload = await databaseService.creatPost(prepardData);
      }
      if (upload) {
