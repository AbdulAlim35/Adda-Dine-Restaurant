...
function BlogList() {
  ...
  useEffect(() => {
    const fetchBlogs = async () => {
      let list = await databaseService.listPost();
  ...
  const searchData = async () => {
    ...
    const lisi = await databaseService.listQuery(queries);
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">
            Capritech Menu Posts
          </h1>
          <p className="text-gray-600 mt-2">Manage all your menu content</p>
        </div>
        <Link
          to={"/admin/add-blog"}
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="relative">
            ...
            >
              ...
              <option value="sandwic">Sandwic</option>
